...
## Applications
### Development
- [Xcode 13](https://apps.apple.com/us/app/xcode/id497799835) - native IDE for Apple platforms
- [SnippetsLab](https://apps.apple.com/us/app/snippetslab/id1006087419) - manager for code snippets with cloud sync
- [CotEditor](https://apps.apple.com/us/app/coteditor/id1024640650) - light-weight text editor
- [Expressions](https://apps.apple.com/us/app/expressions/id913158085) - helpful tool for quickly creating regular expressions
- [SF Symbols](https://developer.apple.com/design/human-interface-guidelines/sf-symbols/overview/) - configurable symbols by Apple for application interfaces

### Utilities
- [Eggplant Functional](https://www.eggplantsoftware.com) - UI automation via RDP, VNC or WebDriver connection
- [Alfred 5](https://www.alfredapp.com) - Spotlight replacement and productivity catalyst
...
- [The Unarchiver](https://macpaw.com/the-unarchiver) - lightweight data decompression tool
- [Postman](https://www.postman.com) - collaborative API testing platform
...
- [MediaInfo](https://mediaarea.net/en/MediaInfo) - display technical and tag information for audio and video files
...
- [IINA](https://iina.io) - modern open-source media player
...
- [Oh-My-Zsh](https://ohmyz.sh) - extensible, open-source framework for ZSH config
  - [copydir](https://github.com/robbyrussell/oh-my-zsh/tree/master/plugins/copypath) - copies the path of your current folder to the system clipboard
